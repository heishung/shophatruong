<?php
/*
Plugin Name: NinjaTeam Facebook Messenger
...
define('FACEBOOK_MESSENGER_PLUGIN_VER', '2.7');
...
function plugin_messenger_row_meta( $links, $file ) {
		if ( $file == "facebook-messenger/facebook-messenger.php" ) {
			$row_meta = array(
                ...
                'view'    => '<a href="http://codecanyon.net/item/facebook-messenger-for-wordpress/16392065" title="Rate this plugin 5 stars on CodeCanyon">' . __( ' Don\'t forget to give me 5 star rating ★★★★★ :)', 'fb_messenger' ) . '</a>',
			);
